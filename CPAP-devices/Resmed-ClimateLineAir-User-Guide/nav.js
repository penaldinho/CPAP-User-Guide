function injectNav(currentPageFile) {
  ...
  if (navContainer) {
    ...
    const localChatHref = `http://localhost:3000/chat-setup.html?guide=climatelineair&family=cpap${setupGuidesQuery}${activeTaskQuery}${participantQuery}${researchQuery}`;
